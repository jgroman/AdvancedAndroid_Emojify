...
class Emojifier {
    ...
    // COMPLETED (6) Create a method called addBitmapToFace() which takes the background bitmap, the Emoji bitmap, and a Face object
    // as arguments and returns the combined bitmap with the Emoji over the face.
    /**
